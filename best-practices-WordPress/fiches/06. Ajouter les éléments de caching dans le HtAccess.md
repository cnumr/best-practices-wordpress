...
La fiche #[12. Utiliser un système Cache](./fiches/12.%20Utiliser%20un%20syst%C3%A8me%20Cache.md) nous parle de l'importance du cache et de sa mise en place via des extensions WordPress.
...
Maintenant, compressons notre image (gzip), elle est déjà plus rapide à charger (bien sûr, nous partons du principe qu'elle est bien dimensionnée, et au bon format. cf fiches #[22. La taille des images](./fiches/22.%20La%20taille%20des%20images.md) & #[23. Le poids des images](./fiches/23.%20Le%20poids%20des%20images.md)).
